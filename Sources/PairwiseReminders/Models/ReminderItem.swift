...
struct ReminderItem: Identifiable, Equatable, @unchecked Sendable {
    ...
    /// How many pairwise comparisons this item has participated in (from SwiftData).
    var comparisonCount: Int

    init(from ekReminder: EKReminder, eloRating: Double = 1000.0, kFactor: Double = 32.0, comparisonCount: Int = 0) {
    ...
    init(id: String, ekReminder: EKReminder, eloRating: Double = 1000.0, kFactor: Double = 32.0, comparisonCount: Int = 0) {
        self.id = id
        self.ekReminder = ekReminder
        self.eloRating = eloRating
        self.kFactor = kFactor
